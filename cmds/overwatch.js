...
module.exports = {
  run: function (djs, m, args) {
    let region = args[0];
    let tag = args[1];
    if(region == undefined || tag == undefined) {
      return m.channel.send("Here's how you should run this command: `!overwatch {region} {tag}`. Your region is either `us`, `eu`, or `asia`. Your tag is something like `doamatto#1428`.");
    }
    ...
    nfetch(`https://ow-api.com/v1/stats/pc/${region}/${tagAlt}/profile`, {
      method: 'GET'
